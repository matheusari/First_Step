/* Código desenvolvido para calcular o valor total em diárias dos hóspedes. É importante dizer que hóspedes menores de 5 anos
possuem gratuidade e maiores de 80 anos pagam meia. O resto dos hóspedes paga a tarifa completa. Além disso, mostramos ao final
